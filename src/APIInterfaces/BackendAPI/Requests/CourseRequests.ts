...
const COURSE_EXPORT = (courseId: number): string => urlJoin(COURSE_ID(courseId), '/export/');
...
export const getStudentGrades = async (params: GetStudentGradesOptions): Promise<AxiosResponse<GetStudentGradesResponse>> => {
    try {
        return await AxiosRequest.get('/courses/statistics/questions',
            {
                params
            });
    } catch (e) {
