...
import { STATISTICS_SIMPLIFIED_HEADERS } from './TableColumnHeaders';
            ...
            <div style={{ maxWidth: '100%' }}>
                ...
                { loading ?
                    ...
                    <MaterialTable
                        ...
                        />}
                        columns={(view === StatisticsView.ATTEMPTS || view === StatisticsViewFilter.PROBLEMS_FILTERED) ? attemptCols : STATISTICS_SIMPLIFIED_HEADERS}
                        data={rowData}
                        actions={actions}
                        onRowClick={nextView}
                        options={{
